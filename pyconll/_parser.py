...
def _create_sentence(sent_lines: Iterable[str], columns: Optional[Tuple[str, ...]]) -> Sentence:
    """
...
def iter_sentences(lines_it: Iterable[str], columns: Optional[Tuple[str, ...]]) -> Iterator[Sentence]:
    """
